    ...
    public class PostgresqlDatabaseProvider : IDatabaseProvider
    {
        ...
        public DataResult ExecuteNonQuery(DataSettings settings)
        {
            ...
            try
            {
                ...
                using (NpgsqlCommand command = new NpgsqlCommand(settings.Task, this.connection))
                {
        ...
        public void Initialise(IDirector context = null)
        {
            ...
            this.connection = new NpgsqlConnection(this.Connection.ConnectionString);
        }
        ...
        /// </summary>
        /// <param name="NpgsqlCommand">The SQL command.</param>
        private static NpgsqlParameter AddReturnValueParameter(NpgsqlCommand sqlCommand)
        {
            NpgsqlParameter returnValueParameter = null;
        ...
        private static NpgsqlParameter[] GetSqlParameters(DataParameters parameters)
        {
            List<NpgsqlParameter> sqlParms = new List<NpgsqlParameter>();
        ...
        private void UpdateParameters(DataParameters dataParameters, NpgsqlParameterCollection sqlParameterCollection)
        {
        ...
        private string GenerateRequestText(NpgsqlCommand command)
        {
