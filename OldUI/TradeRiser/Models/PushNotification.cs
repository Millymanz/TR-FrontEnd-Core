...
namespace TradeRiser.Models
{
    public static class PushNotification
    {
        ...
        {
            //ParameterizedThreadStart ptsPokeIn = new ParameterizedThreadStart(ReverseAjax);
            //Thread pokeInThread = new Thread(ptsPokeIn);
            //pokeInThread.Start(userQuerySessionID);
