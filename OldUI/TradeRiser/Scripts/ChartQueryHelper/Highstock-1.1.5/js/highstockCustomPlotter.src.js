...
function Chart(userOptions, callback) {
	...
	function firstRender() {
		...
		if (HighchartsCustomPlotter.RangeSelector && options.rangeSelector.enabled) {
			chart.rangeSelector = new HighchartsCustomPlotter.RangeSelector(chart);
		}
		...
		if (HighchartsCustomPlotter.Scroller && (options.navigator.enabled || options.scrollbar.enabled)) {
			chart.scroller = new HighchartsCustomPlotter.Scroller(chart);
		}
 ...
 * @param {Object} chart
 */
HighchartsCustomPlotter.Scroller = function (chart) {
 ...
 * @param {Object} chart
 */
HighchartsCustomPlotter.RangeSelector = function (chart) {
	var renderer = chart.renderer,
		rendered,
 ...
 */
HighchartsCustomPlotter.StockChart = function (options, callback) {
 ...
 *****************************************************************************/
// global variables
extend(HighchartsCustomPlotter, {
	Chart: Chart,
