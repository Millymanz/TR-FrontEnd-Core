$(function() {
  ...
  $("#loadChart").on("click", function(evt) {
	
		alert("Loading Chart!!");

		$("#resultCanvas").empty(); 	
		
		widgetPlacerT("container", 2);
		
		dataCalculations(data);
  });
  
  
  function widgetPlacerT(chartClassName, iter) {

		var markup = "<div id='" + chartClassName + "' style='height: 850px; min-width: 500px;display:inline-block;width:80%'></div>";

//        $("#resultsCanvas").append($(markup));
		$("#resultsCanvas").append("<strong>Hello</strong>");
