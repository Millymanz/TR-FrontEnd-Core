(function(H) {
    H.wrap(H.Chart.prototype, 'init', function(origFunc) {
        ...
        function openSpeechBubble(content, pinLeft, pinTop) {
            $("#speech-bubble").remove();
            $("#speech-bubble-pointer").remove();
            var speechBubble = '' + '<div id="speech-bubble" style="display:none;">' + '<div class="container">' + '<div class="close-bar"><div class="close">X</div></div>' + '<div class="bubblecontent">' + content + '</div>' + '</div>' + '</div>';
