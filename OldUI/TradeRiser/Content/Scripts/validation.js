var validation = {
        ...
        for (var i = 0, vlength = validationTypes.length; i < vlength; i++) {
            var validationAttribute = validationTypes[i].dataattribute;
                ...
                if (attributeFound) {
                    ...
                    $items = $control.find("input[" + validationAttribute + "],select[" + validationAttribute + "],textarea[" + validationAttribute + "]");
                }
    ...
    getErrorContainer: function ($element) {
        ...
        var $errorcontainer = $("#" + validation.getControlIdentifier($element) + "-field-validation");
    ...
    setDefaultControlStyle: function ($element, isValid) {
        ...
        if (isValid) {
            ...
            //    $tag.find("input[type=radio]").removeClass("invalid"); tabbed - window - content
            //}
            else {
            ...
            var $controlToValidate = $(this);
                for (var i = 0, vlength = validationTypes.length; i < vlength; i++) {
                    ...
                    if (attributeFound) {
                        ...
                        // inputs are in child elements
                        $items = $controlToValidate.find("input[" + validationAttribute + "],select[" + validationAttribute + "],textarea[" + validationAttribute + "]");
                    }
                    ...
                    for (var j = 0; j < itemlength; j++) {
                        ...
                        if (invalidElementIndex < 1) {
                            ...
                            if (!isValid) {
                                ...
                                // insert the element id in invalid elements arrayssss
